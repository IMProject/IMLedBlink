...
LedBlink/Src/stm32l4xx_it.c \
LedBlink/Src/stm32l4xx_hal_msp.c \
LedBlink/Src/system_stm32l4xx.c \
...
LDSCRIPT_SIGNATURE = STM32L496RETx_FLASH_SIGNATURE.ld

# libraries
LIBS = -lc -lm -lnosys 
LIBDIR = 
LDFLAGS = $(MCU) -u _printf_float $(LIBDIR) $(LIBS) -Wl,-Map=$(BUILD_DIR)/$(TARGET).map,--cref -Wl,--gc-sections
LDFLAGS_SIGNATURE := -T$(LDSCRIPT_SIGNATURE) $(LDFLAGS)
